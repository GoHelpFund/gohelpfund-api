package com.gohelpfund.api.v1.zuul_server.filters;


import com.gohelpfund.api.v1.zuul_server.model.UserInfo;
...
public class AuthenticationFilter extends ZuulFilter {
        ...
        try {
            restExchange =
                    restTemplate.exchange(
                            "http://authentication-service:8764/api/v1/auth/check_token?token={token}",
                            HttpMethod.GET,
    ...
    public Object run() {
        ...
        if ( ctx.getRequest().getRequestURI().equals("/authentication-service/api/v1/auth/authenticate")){
            return null;
        }

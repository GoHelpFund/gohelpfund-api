...
INSERT INTO campaigns (campaign_id, category_id, fundraiser_id, wallet_id, status_id, campaign_title, campaign_description, amount_goal, expenses_description, location, start_date, end_date, backers)

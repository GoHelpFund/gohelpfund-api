package com.gohelpfund.api.v1.campaign_service.campaigns.controllers;

import com.gohelpfund.api.v1.campaign_service.campaigns.controllers.assembler.CampaignResourceAssembler;
...
import com.gohelpfund.api.v1.campaign_service.campaigns.model.status.CampaignStatusType;
import com.gohelpfund.api.v1.campaign_service.campaigns.model.wallet.Wallet;
import com.gohelpfund.api.v1.campaign_service.campaigns.services.CampaignService;
...
public class CampaignController {
    ...
    public ResponseEntity<ResourceSupport> donate(@PathVariable("id") String campaignId, @RequestBody @Valid Donation donation) {
        ...
        String walletId = campaign.getWalletId();
        String fundraiserId = getValueFromJWTByKey("fundraiser_id");
        Integer amount = donation.getAmount();

        Wallet newWallet = service.updateCampaign(campaignId, walletId, fundraiserId, amount);
        campaign.withWallet(newWallet);
        return ResponseEntity.ok(assembler.toResource(campaign));
    }

package com.gohelpfund.api.v1.campaign_service.campaigns.controllers.advices;

import com.gohelpfund.api.v1.campaign_service.campaigns.controllers.errors.ApiError;
...
public class CampaignExceptionHandler{
    private static final Logger logger = LoggerFactory.getLogger(CampaignExceptionHandler.class);

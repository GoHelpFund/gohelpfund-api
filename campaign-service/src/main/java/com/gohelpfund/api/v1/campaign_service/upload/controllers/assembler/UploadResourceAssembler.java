package com.gohelpfund.api.v1.campaign_service.upload.controllers.assembler;

import com.gohelpfund.api.v1.campaign_service.upload.controllers.UploadController;
...
public class UploadResourceAssembler implements ResourceAssembler<Upload, Resource<Upload>> {
    ...
    public Resource<Upload> toResource(Upload upload) {
        ...
        Resource<Upload> uploadResource = new Resource<>(upload,
                ControllerLinkBuilder.linkTo(methodOn(UploadController.class).one()).withRel("upload")
        );

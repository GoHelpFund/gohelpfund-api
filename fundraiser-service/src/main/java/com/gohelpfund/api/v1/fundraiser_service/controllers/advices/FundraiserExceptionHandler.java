package com.gohelpfund.api.v1.fundraiser_service.controllers.advices;

import com.gohelpfund.api.v1.fundraiser_service.controllers.errors.ApiError;
...
@ControllerAdvice
public class FundraiserExceptionHandler{
    private static final Logger logger = LoggerFactory.getLogger(FundraiserExceptionHandler.class);

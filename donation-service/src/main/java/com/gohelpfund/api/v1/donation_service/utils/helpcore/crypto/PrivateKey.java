...
import com.gohelpfund.api.v1.donation_service.utils.helpcore.util.ApplicationRandom;
...
import static com.gohelpfund.api.v1.donation_service.utils.helpcore.crypto.Numbers.N;
import static com.gohelpfund.api.v1.donation_service.utils.helpcore.crypto.Numbers.S_MAX;
...
public class PrivateKey {
    ...
    public static PrivateKey ofWif(boolean mainNet, String wif) {
        ...
        byte prefix = mainNet ? (byte) 0xCC : (byte) 0xEF;
    ...
    private static void validateWifFormat(boolean mainNet, String wif) {
        ...
        List<Character> prefixWifComp = mainNet ? asList('K', 'L', 'X') : singletonList('c');

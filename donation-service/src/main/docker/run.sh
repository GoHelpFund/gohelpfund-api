...
echo "********************************************************"
echo "Starting Donation Service with Configuration Service via Eureka :  $EUREKASERVER_URI" ON PORT: $SERVER_PORT;
...
java -Djava.security.egd=file:/dev/./urandom -Dserver.port=$SERVER_PORT   \
     ...
     -Dspring.profiles.active=$PROFILE -jar /usr/local/donation-service/@project.build.finalName@.jar
